...
\item Creación de una interfaz que muestre a los usuarios finales la distribución de clases en vivo de la línea de producción.
	\begin{itemize}
		\item Al mostrar la distribución de clases, se mostrará qué porcentaje corresponde a nuggets correctamente producidos vs nugget con algun tipo de error, asi como un desglose de los errores por su tipo.
	\end{itemize}	
\end{itemize}
...
\begin{itemize}
	\item Se dispone de 10 horas semanales para el desarrollo del mismo.
	...
	\item Se tendrá disponibilidad limitada para ingresar a la planta y realizar trabajos dentro de la misma, dependiendo de la naturaleza de los trabajos a realizar.
	\item Se acepta un porcentaje de detección de 90\% para la identificación de nuggets en la línea de producción.
	\item Se acepta un porcentaje de precisión en la clasificación de 10\% por clase.
\end{itemize}
...
\item Etiquetado de datos (30 horas)
	\begin{enumerate}
	\item Utilizar software de etiquetado para marcar y clasificar cada nugget en las imágenes. (30 horas)
	\end{enumerate}
\item Desarrollo del pipeline de preprocesamiento (30 horas)
	...
	\end{enumerate}
\item Entrenamiento del modelo de detección y clasificación (120 horas)
	\begin{enumerate}
...
\item Documentación (65 horas)
	...
	\item Documentar el entrenamiento y evaluación del modelo de IA. (35 horas)
	\item Documentar el desarrollo e implementación de la interfaz web. (15 horas)
	\end{enumerate}
\end{enumerate}

Cantidad total de horas: 460 horas.
